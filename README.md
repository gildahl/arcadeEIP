# arcadeEIP : Arcade [E]mulator [I]ntegration [P]layer
...
-------------------------------
- See [Quick Start 1 - MAME.txt](https://github.com/gildahl/arcadeEIP/blob/main/distribution/Quick%20Start%201%20-%20MAME.txt)
- See [Quick Start 2 - MARQUEE.txt](https://github.com/gildahl/arcadeEIP/blob/main/distribution/Quick%20Start%202%20-%20MARQUEE.txt)
- See [Wiki Page](https://github.com/gildahl/arcadeEIP/wiki) for comprehensive documentation and examples. 

ONLINE DOCUMENTATION
--------------------
- [Configuration Reference Guide](https://docs.google.com/document/d/1qgrhwRJc4mvlUft9mtI_mBD2EnXSNo9x/edit?usp=sharing&ouid=104524226769236382668&rtpof=true&sd=true)
- [Command-Line Reference Guide](https://docs.google.com/document/d/1lZmdyrp3ghYUGqzjInXDCzLWVle89KZuhxRJoAcnaDY/edit?usp=sharing)
- [Rules Reference Guide](https://docs.google.com/document/d/1usH6u_og0dDxwoNRqGK2VthXj5pwte2_CY2eQpPQDiE/edit?usp=sharing)
...
before playing (which dilutes the traditional arcade machine experience IMO), I wanted the ability to keep 
my multi-game arcade machine always immediately playable with a fresh game beckoning me on the screen and 
make explicit game selection an option for only when I wanted to play something specific rather than always
a requirement. 
...
Note: The "Magic Key" permits a single button to perform two functions (Exit and Menu toggle) with
the ability to swap what happens on hold vs. tap in the configuration.
